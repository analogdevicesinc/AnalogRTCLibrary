...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("---------------------");
    Serial.println("ALARM1 use case example:");
    ...
    ret = rtc.set_alarm(MAX31342::ALARM1, &rtc_ctime, MAX31342::ALARM_PERIOD_EVERYSECOND);
    if (ret) {
        Serial.println("Set alarm failed!");
    }

    ret = rtc.irq_enable(MAX31342::INTR_ID_ALARM1);
    if (ret) {
