...
int pin_inta = 2;// interrupt pins that connects to MAX31342
struct tm rtc_ctime;
...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("---------------------");
    Serial.println("RTC timer use case timer example:");
    Serial.println(" ");
    ...
    rtc.timer_stop();
    rtc.timer_init(16, true, MAX31342::TIMER_FREQ_16HZ);
    rtc.irq_enable(MAX31342::INTR_ID_TIMER);
    rtc.timer_start();
}
