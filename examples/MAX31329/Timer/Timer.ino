...
MAX31329 rtc = MAX31329(&Wire, MAX31329_I2C_ADDRESS);
MAX31329::reg_status_t g_stat;

int pin_interrupt = 2;// interrupt pins that connects to MAX31329
struct tm rtc_ctime;
...
void setup() {
    ...
    rtc.timer_init(16, true, MAX31329::TIMER_FREQ_16HZ);

    rtc.irq_enable(MAX31329::INTR_ID_TIMER);
